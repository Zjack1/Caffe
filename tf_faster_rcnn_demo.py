...
from model.test import im_detect  #im_detect 生成RPN候选框

from model.nms_wrapper import nms  #nms 进行非极大值抑制
...
#参数im为测试图片； class_name 为类别名称，在前面定义的 CLASSES 中； 
#dets为非极大值抑制后的bbox和score的数组；thresh是最后score的阈值，高于该阈值的候选框才会被画出来。
